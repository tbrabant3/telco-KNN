...
#sklearn.preprocess.labelencoder to convert values to numbers

# convert all values to numbers
# split targets, features into x, y test and train
...
def main():
    ...
    test_set = []
    split = 0.67
    load_dataset('telco_data2.csv', split, training_set, test_set)
